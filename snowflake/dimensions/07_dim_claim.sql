...
-- Create indexes
CREATE INDEX IDX_CLAIM_ID ON DIM_CLAIM(CLAIM_ID);
CREATE INDEX IDX_CLAIM_CURRENT ON DIM_CLAIM(IS_CURRENT);
CREATE INDEX IDX_CLAIM_STATUS ON DIM_CLAIM(CLAIM_STATUS);
CREATE INDEX IDX_CLAIM_FILED_DATE ON DIM_CLAIM(CLAIM_FILED_DATE);
