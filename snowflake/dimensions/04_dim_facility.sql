...
-- Create indexes
CREATE INDEX IDX_FACILITY_ID ON DIM_FACILITY(FACILITY_ID);
CREATE INDEX IDX_FACILITY_CURRENT ON DIM_FACILITY(IS_CURRENT);
CREATE INDEX IDX_FACILITY_STATE ON DIM_FACILITY(STATE);
CREATE INDEX IDX_FACILITY_VISN ON DIM_FACILITY(VISN_NUMBER);
