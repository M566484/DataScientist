...
-- Create indexes
CREATE INDEX IDX_CONDITION_CATEGORY ON DIM_MEDICAL_CONDITION(CONDITION_CATEGORY);
CREATE INDEX IDX_CONDITION_ICD10 ON DIM_MEDICAL_CONDITION(ICD10_CODE);
CREATE INDEX IDX_CONDITION_ACTIVE ON DIM_MEDICAL_CONDITION(ACTIVE_FLAG);
CREATE INDEX IDX_CONDITION_DIAGNOSTIC_CODE ON DIM_MEDICAL_CONDITION(DIAGNOSTIC_CODE);
