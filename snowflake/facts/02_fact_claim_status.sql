...
-- Create indexes
CREATE INDEX IDX_FACT_CLAIM_VETERAN ON FACT_CLAIM_STATUS(VETERAN_KEY);
CREATE INDEX IDX_FACT_CLAIM_KEY ON FACT_CLAIM_STATUS(CLAIM_KEY);
CREATE INDEX IDX_FACT_CLAIM_STATUS ON FACT_CLAIM_STATUS(CURRENT_STATUS);
CREATE INDEX IDX_FACT_CLAIM_DECISION_FLAG ON FACT_CLAIM_STATUS(DECISION_MADE);
