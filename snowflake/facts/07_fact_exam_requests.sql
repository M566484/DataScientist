...
CREATE OR REPLACE TABLE fact_exam_requests (
    ...
    FOREIGN KEY (assigned_evaluator_sk) REFERENCES IDENTIFIER(fn_get_dw_database() || '.WAREHOUSE.dim_evaluators')(evaluator_sk),
    FOREIGN KEY (previous_examiner_sk) REFERENCES IDENTIFIER(fn_get_dw_database() || '.WAREHOUSE.dim_evaluators')(evaluator_sk),
    FOREIGN KEY (request_received_date_sk) REFERENCES IDENTIFIER(fn_get_dw_database() || '.WAREHOUSE.dim_dates')(date_sk)
)
