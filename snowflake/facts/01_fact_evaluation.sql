...
CREATE INDEX IDX_FACT_EVAL_VETERAN ON FACT_EVALUATION(VETERAN_KEY);
CREATE INDEX IDX_FACT_EVAL_EVALUATOR ON FACT_EVALUATION(EVALUATOR_KEY);
CREATE INDEX IDX_FACT_EVAL_FACILITY ON FACT_EVALUATION(FACILITY_KEY);
CREATE INDEX IDX_FACT_EVAL_DATE ON FACT_EVALUATION(EVALUATION_DATE_KEY);
CREATE INDEX IDX_FACT_EVAL_CLAIM ON FACT_EVALUATION(CLAIM_KEY);
CREATE INDEX IDX_FACT_EVAL_CONDITION ON FACT_EVALUATION(MEDICAL_CONDITION_KEY);
CREATE INDEX IDX_FACT_EVAL_COMPLETED ON FACT_EVALUATION(EVALUATION_COMPLETED_FLAG);
