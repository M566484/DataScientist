...
-- Create indexes
CREATE INDEX IDX_FACT_SNAPSHOT_FACILITY ON FACT_DAILY_SNAPSHOT(FACILITY_KEY);
CREATE INDEX IDX_FACT_SNAPSHOT_DATE ON FACT_DAILY_SNAPSHOT(SNAPSHOT_DATE_KEY);
