...
-- Create indexes
CREATE INDEX IDX_FACT_APPT_VETERAN ON FACT_APPOINTMENT(VETERAN_KEY);
CREATE INDEX IDX_FACT_APPT_FACILITY ON FACT_APPOINTMENT(FACILITY_KEY);
CREATE INDEX IDX_FACT_APPT_DATE ON FACT_APPOINTMENT(APPOINTMENT_DATE_KEY);
CREATE INDEX IDX_FACT_APPT_SCHEDULED_DATE ON FACT_APPOINTMENT(SCHEDULED_DATE_KEY);
CREATE INDEX IDX_FACT_APPT_ATTENDED ON FACT_APPOINTMENT(ATTENDED_FLAG);
CREATE INDEX IDX_FACT_APPT_NO_SHOW ON FACT_APPOINTMENT(NO_SHOW_FLAG);
CREATE INDEX IDX_FACT_APPT_METHOD ON FACT_APPOINTMENT(APPOINTMENT_METHOD);
